...
<script>
  ...
  export default {
    ...
    created() {
      const categoryId = this.$route.query.categoryId ? parseInt(this.$route.query.categoryId) : null;
      if (categoryId) {
        this.$store.dispatch('setCategoryId', categoryId);
      }
      this.queryParams.unitTypeId = this.$route.query.unitTypeId ? parseInt(this.$route.query.unitTypeId) : null;
      this.queryParams.itemId = this.$route.query.itemId ? parseInt(this.$route.query.itemId) : null;
      this.queryParams.raceId = this.$route.query.raceId ? parseInt(this.$route.query.raceId) : null;

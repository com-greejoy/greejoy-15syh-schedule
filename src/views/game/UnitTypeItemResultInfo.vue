<template>
  <div class="unitType-item-result-info" v-loading="loading" element-loading-spinner="el-icon-loading">
    <div v-for="(i, idx) in dataList">
      <el-collapse class="item-collapse">
        <el-collapse-item :title="i.itemStr" :name="i.itemStr" @click.native="handleItemClick(i, idx)">
          <template slot="title">
            <div class="title">
              ...
              <div class="result-info">
                ...
                <div class="item-medal">
                  <span class="medal"><img src="~assets/img/game/1st.png">{{i.goldCount}}金</span>
                  <span class="medal"><img src="~assets/img/game/2nd.png">{{i.silverCount}}银</span>
                  <span class="medal"><img src="~assets/img/game/3rd.png">{{i.bronzeCount}}铜</span>
                </div>
              </div>
            </div>
          </template>
          <div style="min-height: 40px" v-loading="!i.resultList.length" element-loading-spinner="el-icon-loading">
            <el-collapse class="race-collapse" v-for="r in i.resultList" >
              <el-collapse-item :title="r.raceName" :name="r.id" @click.native="handleRaceClick()">
                <template slot="title">
                  <div class="head">
                    ...
                    <div class="race-medal">
                      <el-tooltip effect="dark" placement="top">
                        <div slot="content">
                          <div>奖牌：{{r.medal}}</div>
                          <div v-if="r.extra && r.extra.extraMedal > 0">超破：{{r.extra ? r.extra.extraMedal : 0}}</div>
                        </div>
                        <span>
                          <medal-img
                ...
                <div class="sporter-list">
                  <div class="sporter-info" v-for="sp in r.sporterList" @click="toSporterInfo(sp)">
                    <el-image v-if="sp.photo" class="photo" :src="sp.photo" fit="cover" :lazy="true" />

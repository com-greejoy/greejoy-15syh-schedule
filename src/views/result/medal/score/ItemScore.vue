      ...
      <el-table v-loading="loading" :data="dataList" show-summary>
        ...
        <el-table-column label="第一名" align="center" prop="score1" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 1, scope.row.score1)"
              class="number"
            >
              {{ scope.row.score1 }}
            </span>
        ...
        <el-table-column label="第二名" align="center" prop="score2" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 2, scope.row.score2)"
              class="number"
            >
              {{ scope.row.score2 }}
            </span>
        ...
        <el-table-column label="第三名" align="center" prop="score3" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 3, scope.row.score3)"
              class="number"
            >
              {{ scope.row.score3 }}
            </span>
        ...
        <el-table-column label="第四名" align="center" prop="score4" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 4, scope.row.score4)"
              class="number"
            >
              {{ scope.row.score4 }}
            </span>
        ...
        <el-table-column label="第五名" align="center" prop="score5" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 5, scope.row.score5)"
              class="number"
            >
              {{ scope.row.score5 }}
            </span>
        ...
        <el-table-column label="第六名" align="center" prop="score6" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 6, scope.row.score6)"
              class="number"
            >
              {{ scope.row.score6 }}
            </span>
        ...
        <el-table-column label="第七名" align="center" prop="score7" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 7, scope.row.score7)"
              class="number"
            >
              {{ scope.row.score7 }}
            </span>
        ...
        <el-table-column label="第八名" align="center" prop="score8" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 8, scope.row.score8)"
              class="number"
            >
              {{ scope.row.score8 }}
            </span>
        ...
        <el-table-column label="第九名" align="center" prop="score9" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 9, scope.row.score9)"
              class="number"
            >
              {{ scope.row.score9 }}
            </span>
        ...
        <el-table-column label="第十名" align="center" prop="score10" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 10, scope.row.score10)"
              class="number"
            >
              {{ scope.row.score10 }}
            </span>
        ...
        >
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 11, scope.row.score11)"
              class="number"
            >
              {{ scope.row.score11 }}
            </span>
        ...
        >
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 12, scope.row.score12)"
              class="number"
            >
              {{ scope.row.score12 }}
            </span>
        ...
        <el-table-column label="预赛超破" align="center" prop="score0" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 0, scope.row.score0)"
              class="number"
            >
              {{ scope.row.score0 }}
            </span>

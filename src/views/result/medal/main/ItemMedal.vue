      ...
      <el-table v-loading="loading" :data="dataList" show-summary>
        ...
        <el-table-column label="金牌" align="center" prop="goldCount" sortable>
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 1, scope.row.goldCount)"
              class="number"
            >
              {{ scope.row.goldCount }}
            </span>
        ...
        >
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 2, scope.row.silverCount)"
              class="number"
            >
        ...
        >
          <template scope="scope">
            <span
              @click="handleNumberClick(scope.row, 3, scope.row.bronzeCount)"
              class="number"
            >
